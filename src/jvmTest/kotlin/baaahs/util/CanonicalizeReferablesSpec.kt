...
@Serializable // (with = Address.CustomSerializer::class)
private data class Address(val zip: String) : Referable {
//    class CustomSerializer : KSerializer<Address> {
//        override val descriptor: SerialDescriptor
//            get() = Address.serializer().descriptor
//
//        override fun deserialize(decoder: Decoder): Address {
////            debug()
//            return Address.serializer().deserialize(decoder)
//        }
//
//        override fun serialize(encoder: Encoder, value: Address) {
//            debug()
//            Address.serializer().serialize(encoder, value)
//        }
//    }
}
