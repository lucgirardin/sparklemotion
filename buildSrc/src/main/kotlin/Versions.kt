object Versions {
    ...
    const val serializationRuntime = "1.0-M1-1.4.0-rc"
    ...
    const val kotlinReact = "16.13.1-pre.110-kotlin-1.4.0-rc"
    const val kotlinStyled = "1.0.0-pre.110-kotlin-1.4.0-rc"
    const val kotlinxHtml = "0.7.7"
}